    ...
    >
      <div className="flex items-start justify-start gap-2 md:gap-6">
        ...
        <div className="inline-flex flex-col items-start justify-start gap-2">
          <h1 className="text-base font-normal font-semibold leading-normal ">
            Step into the {pageName} experience.
          </h1>
          {wip ? (
            <div className="text-base font-normal font-normal leading-normal ">
      ...
      <div className="flex w-full min-w-36 items-center justify-end md:w-fit">
        <NextLink
          href={`/${pageUrl}#guide`}
          className={clsx(
            'w-full rounded-3xl bg-white px-4 py-2 font-normal',
